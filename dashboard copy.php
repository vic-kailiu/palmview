                  ...
                  <div class="col-lg-9 main-chart">
                     <div class="row mtbox">
                        <div class="col-md-2 col-sm-2 col-md-offset-1 box0">
                           <div class="box1">
                              <img src="img/smallicons/flag.png" style="width:80px;height:80px">
                              <h3>Settings</h3>
                           </div>
                        ...
                        <div class="col-md-2 col-sm-2 box0">
                           <div class="box1">
                              <img src="img/smallicons/briefcase.png" style="width:80px;height:80px">
                              <h3>Files</h3>
                           </div>
                           <p>We will implement it soon!</p>
                        </div>
                        <div class="col-md-2 col-sm-2 box0">
                           <div class="box1">
                              <img src="img/smallicons/open-letter.png" style="width:80px;height:80px">
                              <h3>Mail</h3>
                           </div>
                           <p>We will implement it soon!</p>
                        </div>
                        <div class="col-md-2 col-sm-2 box0">
                           <div class="box1">
                              <img src="img/smallicons/bookshelf.png" style="width:80px;height:80px">
                              <h3>Notes</h3>
                           </div>
                           <p>We will implement it soon!</p>
                        </div>
                        <div class="col-md-2 col-sm-2 box0">
                           <div class="box1">
                              <img src="img/smallicons/rocket.png" style="width:80px;height:80px">
                              <h3>Talk!</h3>
                           </div>
                           <p>We will implement it soon!</p>
                        </div>
