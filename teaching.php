            ...
            <div class="row mt">
             ...
             <?php
              for($i=0;$i<$rc;$i++){
                ...
                echo '<div class="embed-responsive embed-responsive-16by9"><iframe class="embed-responsive-item" src="http://www.youtube.com/embed/'.$id.'" frameborder="0" allowfullscreen></iframe></div></div>';
              }
            ?>
            <br><br><br>
