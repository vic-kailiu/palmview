...
try{
  ...
  'SELECT title,videoID FROM VIDEO ORDER BY RAND() order ASC');
  $pstmt->execute();
          ...
          <div class="row mt">
           ...
           <?php
            for($i=0;$i<$rc;$i++){
              ...
              echo '<div class="showback"><h4><i class="fa fa-angle-right"></i>'.$t.'</h4>';
              echo '<div class="embed-responsive embed-responsive-16by9"><iframe class="embed-responsive-item" src="http://www.youtube.com/embed/'.$t.'" frameborder="0" allowfullscreen></iframe></div>';
            }
          ?>
          <br><br><br>
