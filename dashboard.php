...
<body>
    ...
    <section id="container">
                        ...
                        <ul class="dropdown-menu extended inbox">
                            ...
                            <li>
                                <a href="dashboard.php#">
                                    ...
                                    <span class="message">Please do your homework.</span>
                                </a>
                            </li>
                            <li>
                                <a href="dashboard.php#">
                                    ...
                                    <span class="message">Hi, how is everything?</span>
                                </a>
                            </li>
                            <li>
                                <a href="dashboard.php#">
                                    ...
                                    <span class="message">You are allowed to cheat in exams.</span>
                                </a>
                            </li>
                            <li>
        ...
        <aside>
            <div id="sidebar" class="nav-collapse ">
                ...
                <ul class="sidebar-menu" id="nav-accordion">
                    <p class="centered">
                        <a href="profile.php"><img src="img/friends/man.png" class="img-circle" width="60">
                        </a>
                    </p>
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            ...
                            <li><a href="todo_list.php">Todo List</a>
                            </li>
                        </ul>
                    </li>
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li><a href="teaching.php">Video Guide</a>
                            </li>
                            <li><a href="practice.php">Practice Questions</a>
                            </li>
                            <li><a href="quiz.php">Quiz Questions</a>
                            </li>
                        </ul>
                    </li>
                </ul>
                        ...
                        <div class="row mt">
                            ...
                            <div class="col-md-4 col-sm-4 mb">
                                <div class="content-panel pn">
                                    ...
                                    <div class="blog-text">
                                        <p>Palm View believes in children's potential for learning given the right environment and nurturing. Learn how students are taught by clicking <a href="http://www.palmviewpri.moe.edu.sg/cos/o.x?c=/wbn/pagetree&func=view&rid=1159396">here</a>.</p>
                                    </div>
                                </div>
                            </div>
                            <!-- /col-md-4-->
        ...
        <footer class="site-footer">
            <div class="text-center">
              ...
              <a href="dashboard.php#" class="go-top"><i class="fa fa-angle-up"></i></a>
            </div>
        </footer>
        <!--footer end-->
    </section>
    ...
    <script type="text/javascript" src="js/gritter/js/jquery.gritter.js"/>
    <script type="text/javascript" src="js/gritter-conf.js"/>

    <!--script for this page-->
    <script src="js/sparkline-chart.js"/>
    <script src="js/zabuto_calendar.js"/>
